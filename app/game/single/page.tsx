...
export default function SinglePlayerPage() {
  ...
  const immersive = phase === "playing"; // hide chrome while the match plays
  ...
  return (
    <main className="min-h-screen bg-[#0a0a0a]">
      ...
      <div className={`relative max-w-5xl mx-auto px-4 sm:px-6 ${immersive ? "pt-3 pb-8" : "py-8"}`}>
        {phase === "setup" && (
          <div className="mb-6">
            ...
            <p className="text-zinc-500 text-sm mt-1">
              Pick your best squad from your collection and play a 7-a-side match against the CPU.
            </p>
          </div>
        )}

        <FootballGame onPhaseChange={setPhase} />
      </div>
    </main>
  );
}
